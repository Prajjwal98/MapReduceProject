...
class worker_insurance_avg extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public worker_insurance_avg(JFrame parent)
	{
		super(" ",true,true);
		...
		cmdVwPat=new JButton("Show Avg Insured Workers");
