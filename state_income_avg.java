...
class state_income_avg extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public state_income_avg(JFrame parent)
	{
		super("State Income",true,true);
		...
		cmdVwPat=new JButton("Show Avg of State Income");
...
FileSystem fs = FileSystem.get(conf);
 ...
 line=br.readLine();
    ...
    Object columnNames[] = { "STATE NAME", "INCOME" };
 ...
 while(line!=null)
 {
	 System.out.println(line + "....");
	  ...
	  for (String val: line.split("\t"))
	  {
		  if(j==0)
		  {
			  rowData[i][j++]=new definition().get_state(Integer.parseInt(val));
		  }
		  else
		  rowData[i][j++]=val;
