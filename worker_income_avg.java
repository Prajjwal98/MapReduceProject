...
class worker_income_avg extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public worker_income_avg(JFrame parent)
	{
		super("Worker income",true,true);
		...
		cmdVwPat=new JButton("Show Avg of worker's Income");
...
FileSystem fs = FileSystem.get(conf);
 ...
 line=br.readLine();
    ...
    Object columnNames[] = { "Worker", "Income" };
