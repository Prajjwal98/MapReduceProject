...
class con_products extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public con_products(JFrame parent)
	{
...
txtId = new JTextField(10);
		...
		cmdVwPat=new JButton("Show All Records");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==cmdVwPat)
		{
                    ...
                    String args[]={"input_dir","output_dir",txtId.getText()};
                    
                   try{ mr2.startmr(args); 
...
FileSystem fs = FileSystem.get(conf);
 ...
 line=br.readLine();
    ...
    Object columnNames[] = { "EMPID", "EMP NAME", "SALARY","Count" };
